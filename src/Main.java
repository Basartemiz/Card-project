 ...
 * 
 * python3 test_runner.py              # Test all cases
 * python3 test_runner.py --type type1 # Test only type1  
 ...
 * python3 test_runner.py -bv --type type1 # benchmark + verbose + type1
            ...
            while (reader.hasNext()) {
                ...
                switch (command) {
                    case "draw_card": {
                        ...
                        if (scanner.hasNext())
                            hp = scanner.nextInt();
                        out = ml.draw_card(name, att, hp); // suggested method for draw_card command
                        break;
                    }
                    case "battle": {
                        int att = 0;
                        ...
                        if (scanner.hasNext())
                         ...
                         out = ml.battle(att, hp, heal); // suggested method for battle command
                        break;
                    }
                    case "find_winning": {
                        out =ml.find_winning(); // suggested method for find_winning command
                        break;
                    }
                    case "deck_count": {
                        out = ml.deck_count(); // suggested method for deck_count command
                        break;
                    }
                     ...
                     case "discard_pile_count": {
                        out = ml.discard_pile_count(); // suggested method for discard_pile_count command
                        break;
                      }
                    ...
                    case "steal_card": {
                        ...
                        if (scanner.hasNext())
                            hp = scanner.nextInt();
                        out = ml.steal_card(att, hp); // suggested method for steal_card command
                        break;
                    }
                    default: {
